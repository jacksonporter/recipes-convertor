...
class MarkdownLintAuditor(Auditor):
    """Auditor for markdownlint."""

    name = "markdownlint"
    executable = ["yarn", "markdownlint"]
    ...
    def is_supported_filetype(cls, file_path: Path | str) -> bool:
        ...
        return "md" in file_path.suffix.lower()
    ...
    def audit(
        ...
        """Audit the files."""
        logger.debug(f"Running markdownlint audit on {file_path}")
